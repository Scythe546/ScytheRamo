...
((s,r,h)=>{
        ...
        return _createClass(e, [{
            ...
            value() {
                ...
                e || (e = {
                    ...
                    skin: "https://i.imgur.com/RJoC6lk.png",
                    skin2: "https://i.imgur.com/RJoC6lk.png"
                }),
    ...
    a = (()=>{
        ...
        return _createClass(e, null, [{
            ...
            value() {
                ...
                this.doubleSplitKey = c.get("hotkeys", "doubleSplitKey") || "Q",
                this.split16Key = c.get("hotkeys", "split16Key") || "T",
    ...
    oe = (()=>{
        ...
        return _createClass(e, null, [{
            ...
            value() {
				...
				this.maouCircleSkinURL = c.get("theme", "maouCircleSkinURL") || "https://i.imgur.com/kUNpS06.png",
				this.everyoneSkinsURL = c.get("theme", "everyoneSkinsURL") || "https://i.imgur.com/RJoC6lk.png",
				this.multiboxShieldURL = c.get("theme", "multiboxShieldURL") || "https://i.imgur.com/GgACTUB.jpg",
        ...
        return _createClass(e, [{
            ...
            value() {
                ...
                for (const e of se.teammates.values())
					e.isAlive && e.worldID !== A.worldID && e.worldID !== A.worldID2 && this.skinMap.set(e.worldID, e.skin ? (e.skin.includes("imgur") ? e.skin : this.code2url(e.skin)) : "https://i.imgur.com/kUNpS06.png");
				for (const e of ses.teammates.values())
					e.isAlive && e.worldID !== A.worldID && e.worldID !== A.worldID2 && this.skinMap.set(e.worldID, e.skin ? (e.skin.includes("imgur") ? e.skin : this.code2url(e.skin)) : "https://i.imgur.com/kUNpS06.png"),
					e.isAlive2 && e.worldID2 !== A.worldID && e.worldID2 !== A.worldID2 && this.skinMap.set(e.worldID2, e.skin2 ? (e.skin2.includes("imgur") ? e.skin2 : this.code2url(e.skin2)) : "https://i.imgur.com/kUNpS06.png");
			}
        }, {
			key: "getKanjis",
			value() {
    ...
    re = new ((()=>{
        ...
        return _createClass(e, [{
			...
			value() {
				const e2 = new Image;
                e2.src = "https://i.imgur.com/RJoC6lk.png",
